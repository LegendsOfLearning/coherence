defmodule Coherence.Config do
  ...
  * :generate_auth_session_id_callback (UUID)         - fn(conn, user_data, opts) :: String.t
  ...
  * :user_active_field - Include the user active feature
  ...
  [
    ...
    {:generate_auth_session_id_callback, { Coherence.Authentication.Session, :generate_id_as_uuid} },
    {:update_conn_callback, { Coherence.Authentication.Session, :update_conn} },
    {:auth_module, Coherence.Authentication.Session},
    {:create_login, :create_login},
