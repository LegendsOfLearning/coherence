  ...
  defmacro __using__(opts \\ []) do
    quote do
      ...
      if Config.has_option(:confirmable) and
        ...
        """
        def confirm(user) do
          Schemas.change_user(user, %{confirmed_at: Timex.now(), confirmation_token: nil})
        end
        ...
        def confirm!(user) do
          ...
          changeset = Schemas.change_user(user, %{confirmed_at: Timex.now(), confirmation_token: nil})
